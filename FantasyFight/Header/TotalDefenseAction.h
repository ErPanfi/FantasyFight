#ifndef FANTASYFIGHT_ACTION_TOTALDEFENSE_H
#define FANTASYFIGHT_ACTION_TOTALDEFENSE_H

#include "Action.h"
#include "ActionLibraryRecord.h"

class TotalDefenseAction : public Action
{
private:
	class Registerer
	{
...
protected:
	...
	TotalDefenseAction(Character* owner, const ActionLibraryRecord* const actionRecord);
